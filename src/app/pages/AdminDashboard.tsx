...
export default function AdminDashboard() {
  ...
  // FIX: Prevent sensitive data from rendering on the first cycle
  if (user?.role !== "admin") {
    return null;
  }
  ...
  const securityAlerts = [
    {
      id: 1,
      type: "warning",
      message: "Multiple rapid requests detected from user ID: STU-2847",
      time: "2 min ago",
      severity: "medium",
    },
    {
    ...
    },
    {
      id: 3,
      type: "info",
      message: "Unusual access pattern detected in document downloads",
      time: "1 hour ago",
      severity: "low",
    },
    {
      id: 4,
      type: "warning",
      message: "User attempted to access restricted admin panel",
      time: "2 hours ago",
      severity: "medium",
    },
  ];
  ...
  const activityLogs = [
    {
      id: 1,
      user: "Admin User",
      action: "Approved request #1247",
      resource: "Transcript Request",
      time: "5 min ago",
    },
    {
      id: 2,
    ...
    },
    {
      id: 3,
      user: "Admin User",
      action: "Rejected request #1245",
      resource: "Enrollment Letter",
      time: "25 min ago",
    },
    {
      id: 4,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Real-time monitoring and analytics for the secure document system
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="bg-slate-900 border-slate-800">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Daily request volume for the past week
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <Card className="bg-slate-900 border-slate-800">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                Most requested document categories
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
